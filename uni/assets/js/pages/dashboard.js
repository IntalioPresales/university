...
$(function() {    
    ...
    generateBarChart("#members-online-secondary", 24, 50, true, "elastic", 1200, 50, "rgba(255,255,255,0.5)", "members");
    ...
    // Initialize charts
    progressCounter('#hours-available-progress', 38, 2, "#F06292", 0.68, "icon-person text-pink-400", 'نسبة الطلبات على طلب إفادة عن الشهادة', '64% average')
    progressCounter('#goal-progress', 38, 2, "#5C6BC0", 0.82, "icon-vcard text-indigo-400", 'نسبة الطلبات على طلب السكن الجامعي', '87% average')
    // Initialize charts
    progressCounter('#hours-available-progress-secondary', 38, 2, "#F06292", 0.68, "icon-notebook text-pink-400", 'نسبة الطلبات على طلب اعتذار عن الدراسة', '55% average')
    progressCounter('#goal-progress-secondary', 38, 2, "#5C6BC0", 0.82, "icon-users2 text-indigo-400", 'نسبة الطلبات على طلب  قيد للفصل الدراسي', '37% average')
    // Chart setup
